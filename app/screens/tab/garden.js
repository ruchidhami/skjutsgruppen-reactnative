...
import { StyleSheet, ScrollView, Image, TouchableOpacity, View, Linking, Platform } from 'react-native';
...
import { withSupport, withMySupport, withGenerateClientToken, verifyLatestSupport } from '@services/apollo/support';
...
class Garden extends Component {
  ...
  componentDidMount() {
    ...
    getLatestSubscription((error, latestSubscription) => {
      ...
      console.log('asdasd', latestSubscription);
      verifySupport(latestSubscription)
        .then(() => {
          console.log('support subscription verification');
        })
        .catch((e) => {
          console.warn(e);
        });
